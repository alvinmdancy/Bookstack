<div component="editor-toolbox" class="floating-toolbox">
    ...
    <div refs="editor-toolbox@tab-content" data-tab-content="tags" class="toolbox-tab-content">
        ...
        <div class="px-l">
            <?php echo $__themeViews->handleViewInclude('entities.tag-manager', ['entity' => $page], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        </div>
    </div>

    <?php if(userCan(\BookStack\Permissions\Permission::AttachmentCreateAll)): ?>
        <?php echo $__themeViews->handleViewInclude('attachments.manager', ['page' => $page], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php endif; ?>
    ...
    <div refs="editor-toolbox@tab-content" data-tab-content="templates" class="toolbox-tab-content">
        ...
        <div class="px-l">
            <?php echo $__themeViews->handleViewInclude('pages.parts.template-manager', ['page' => $page, 'templates' => $templates], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        </div>
    </div>

    <?php if($comments->enabled()): ?>
        <?php echo $__themeViews->handleViewInclude('pages.parts.toolbox-comments', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php endif; ?>
