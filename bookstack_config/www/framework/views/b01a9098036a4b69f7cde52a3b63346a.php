    ...
    <div class="text-center">
        <div component="dropdown"
            ...
            <ul refs="dropdown@menu" class="dropdown-menu" role="menu">
                ...
                <?php if($isDraft): ?>
                    <li>
                        <a href="<?php echo e($model->getUrl('/delete')); ?>" role="menuitem" class="text-neg icon-item">
                ...
                <?php if(userCan(\BookStack\Permissions\Permission::EditorChange)): ?>
                    <li role="presentation">
                        <hr>
                    </li>
                    <li>
                        <?php if($editor !== \BookStack\Entities\Tools\PageEditorType::Markdown): ?>
                            <a href="<?php echo e($model->getUrl($isDraft ? '' : '/edit')); ?>?editor=markdown-clean" refs="page-editor@changeEditor" role="menuitem" class="icon-item">
                            ...
                            <a href="<?php echo e($model->getUrl($isDraft ? '' : '/edit')); ?>?editor=markdown-stable" refs="page-editor@changeEditor" role="menuitem" class="icon-item">
                                <?php echo (new \BookStack\Util\SvgIcon('swap-horizontal'))->toHtml(); ?>
                                <div>
                                    <?php echo e(trans('entities.pages_edit_switch_to_markdown')); ?>
                        ...
                        <?php if($editor !== \BookStack\Entities\Tools\PageEditorType::WysiwygTinymce): ?>
                            <a href="<?php echo e($model->getUrl($isDraft ? '' : '/edit')); ?>?editor=wysiwyg" refs="page-editor@changeEditor" role="menuitem" class="icon-item">
                                <?php echo (new \BookStack\Util\SvgIcon('swap-horizontal'))->toHtml(); ?>
                        ...
                        <?php if($editor !== \BookStack\Entities\Tools\PageEditorType::WysiwygLexical): ?>
                            <a href="<?php echo e($model->getUrl($isDraft ? '' : '/edit')); ?>?editor=wysiwyg2024" refs="page-editor@changeEditor" role="menuitem" class="icon-item">
                                <?php echo (new \BookStack\Util\SvgIcon('swap-horizontal'))->toHtml(); ?>
                                <div>
            ...
            <ul refs="dropdown@menu" class="wide dropdown-menu">
                <li class="px-m py-s">
                    ...
                    <textarea
                        ...
                        rows="2"
                        maxlength="180"
                        title="<?php echo e(trans('entities.pages_edit_enter_changelog')); ?>"
