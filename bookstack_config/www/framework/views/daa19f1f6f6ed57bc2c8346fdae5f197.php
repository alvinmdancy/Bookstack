...
<?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card template-item border-card p-m mb-m" tabindex="0"
        ...
        <div class="template-item-content" title="<?php echo e(trans('entities.templates_replace_content')); ?>">
            ...
            <div class="text-muted" title="<?php echo e($dates->absolute($template->updated_at)); ?>"><?php echo e(trans('entities.meta_updated', ['timeLength' => $dates->relative($template->updated_at)])); ?></div>
        </div>
