<div refs="page-comments@form-container" hidden class="comment-branch mb-m">
    <div class="comment-box">
        ...
        <div refs="page-comments@reference-row" hidden class="primary-background-light text-muted px-s py-xs">
            <div class="grid left-focus v-center">
                <div>
                    <a refs="page-comments@formReferenceLink" href="#"><?php echo e(trans('entities.comment_reference')); ?></a>
                </div>
                <div class="text-right">
                    <button refs="page-comments@remove-reference-button" class="text-button"><?php echo e(trans('common.remove')); ?></button>
                </div>
            </div>
        </div>
