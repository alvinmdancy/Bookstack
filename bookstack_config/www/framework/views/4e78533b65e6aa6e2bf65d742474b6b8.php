    ...
    <div class="container small">
        ...
        <main class="content-wrap card auto-height">
            ...
            <form action="<?php echo e($book->getUrl()); ?>" method="POST" enctype="multipart/form-data">
                ...
                <?php echo $__themeViews->handleViewInclude('books.parts.form', [
                    'model' => $book,
        ...
        <?php if(userCan(\BookStack\Permissions\Permission::BookDelete, $book) && userCan(\BookStack\Permissions\Permission::BookCreateAll) && userCan(\BookStack\Permissions\Permission::BookshelfCreateAll)): ?>
            <?php echo $__themeViews->handleViewInclude('books.parts.convert-to-shelf', ['book' => $book], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        <?php endif; ?>
    </div>
