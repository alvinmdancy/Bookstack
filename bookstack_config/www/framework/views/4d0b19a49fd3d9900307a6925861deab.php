    ...
    <div components="popup code-editor"
        ...
        <div refs="code-editor@container" class="popup-body" tabindex="-1">
            ...
            <div class="popup-header flex-container-row primary-background">
                ...
                <button class="popup-header-close" refs="popup@hide" title="<?php echo e(trans('common.close')); ?>"><?php echo (new \BookStack\Util\SvgIcon('close'))->toHtml(); ?></button>
            </div>
                    ...
                    <div refs="code-editor@language-options-container" class="lang-options">
                        ...
                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative">
                                ...
                                <button class="lang-option-favorite-toggle action-favourite" title="<?php echo e(trans('common.favourite')); ?>"><?php echo (new \BookStack\Util\SvgIcon('star-outline'))->toHtml(); ?></button>
                                <button class="lang-option-favorite-toggle action-unfavourite" title="<?php echo e(trans('common.unfavourite')); ?>"><?php echo (new \BookStack\Util\SvgIcon('star'))->toHtml(); ?></button>
                            </div>
