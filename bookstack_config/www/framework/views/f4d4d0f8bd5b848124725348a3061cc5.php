...
<div>
    ...
    <span class="text-muted" title="<?php echo e($dates->absolute($activity->created_at)); ?>"><small><?php echo (new \BookStack\Util\SvgIcon('time'))->toHtml(); ?><?php echo e($dates->relative($activity->created_at)); ?></small></span>
</div>
