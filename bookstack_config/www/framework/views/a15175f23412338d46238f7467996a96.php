        ...
        <main class="card content-wrap">
            ...
            <form action="<?php echo e(url("/settings/users/create")); ?>" method="post">
                ...
                <div class="setting-list">
                    <?php echo $__themeViews->handleViewInclude('users.parts.form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                    <?php echo $__themeViews->handleViewInclude('users.parts.language-option-row', ['value' => old('language') ?? config('app.default_locale')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                </div>
