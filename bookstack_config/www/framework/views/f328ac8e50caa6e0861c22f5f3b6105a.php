<div component="page-editor" class="page-editor page-editor-<?php echo e($editor); ?> flex-fill flex"
    ...
    <?php echo $__themeViews->handleViewInclude('pages.parts.editor-toolbar', ['model' => $model, 'editor' => $editor, 'isDraft' => $isDraft, 'draftsEnabled' => $draftsEnabled], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    ...
    <div class="flex flex-fill mx-s mb-s justify-center page-editor-page-area-wrap">
        <div class="page-editor-page-area flex-container-column flex flex-fill">
            ...
            <div class="title-input page-title clearfix">
                <div refs="page-editor@titleContainer" class="input">
                    <?php echo $__themeViews->handleViewInclude('form.text', ['name' => 'name', 'model' => $model, 'placeholder' => trans('entities.pages_title')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                </div>
            </div>
            ...
            <div class="flex-fill flex">
                ...
                <div class="edit-area flex-fill flex">
                    ...
                    <?php if($editor === \BookStack\Entities\Tools\PageEditorType::WysiwygLexical): ?>
                        <?php echo $__themeViews->handleViewInclude('pages.parts.wysiwyg-editor', ['model' => $model], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                    <?php endif; ?>

                    
                    <?php if($editor === \BookStack\Entities\Tools\PageEditorType::WysiwygTinymce): ?>
                        <?php echo $__themeViews->handleViewInclude('pages.parts.wysiwyg-editor-tinymce', ['model' => $model], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                    <?php endif; ?>

                    
                    <?php if($editor === \BookStack\Entities\Tools\PageEditorType::Markdown): ?>
                        <?php echo $__themeViews->handleViewInclude('pages.parts.markdown-editor', ['model' => $model], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
                    <?php endif; ?>
        ...
        <div class="relative flex-fill">
            <?php echo $__themeViews->handleViewInclude('pages.parts.editor-toolbox', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        </div>
    </div>
