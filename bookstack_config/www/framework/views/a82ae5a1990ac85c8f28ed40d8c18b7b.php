...
<?php $__env->startSection('content'); ?>
    ...
    <div id="main-content" class="flex-fill flex height-fill">
        <form action="<?php echo e($page->getUrl()); ?>" autocomplete="off" data-page-id="<?php echo e($page->id); ?>" method="POST" class="flex flex-fill">
            ...
            <?php echo $__themeViews->handleViewInclude('pages.parts.form', ['model' => $page], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
        </form>
    </div>
    
    <?php echo $__themeViews->handleViewInclude('pages.parts.image-manager', ['uploaded_to' => $page->id], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    <?php echo $__themeViews->handleViewInclude('pages.parts.code-editor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
