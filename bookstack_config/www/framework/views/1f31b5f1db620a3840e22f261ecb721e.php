<div style="display: block;"
    ...
    <div component="dropzone"
        ...
        <div refs="attachments@list-container dropzone@drop-target" class="relative">
            ...
            <div refs="attachments@list-panel">
                <?php echo $__themeViews->handleViewInclude('attachments.manager-list', ['attachments' => $page->attachments->all()], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
            </div>
    ...
    <div id="link-form-container" refs="attachments@links-container" hidden class="px-l">
        <?php echo $__themeViews->handleViewInclude('attachments.manager-link-form', ['pageId' => $page->id], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
    </div>
