...
<a href="<?php echo e($entity->getUrl()); ?>"
   class="<?php echo e($type); ?> <?php echo e($type === 'page' && $entity->draft ? 'draft' : ''); ?> <?php echo e($classes ?? ''); ?> entity-list-item"
   data-entity-type="<?php echo e($type); ?>"
